...
*Blue arrows represent more realistic iteration paths of operations. Numbers indicate number of decisions in category. Knowledge and skill development were mentioned themes but are not decisions.*
...
4. **Important features and info?**
   ...
   * What are the important underlying features or concepts that apply? Could include:
     ...
     b. (When appropriate) Create/find a suitable abstract representation of core ideas and information.

5. **What predictive framework?**

   * Which potential predictive frameworks to use? (Decide among possible predictive frameworks or create framework.)
...
7. **Related problems?**
   ...
   * What are related problems or work seen before, and what aspects of their problem-solving process and solutions might be useful in the present context?
...
These decisions establish the specifics needed to solve the problem and include: how to simplify the problem and decompose it into pieces, what specific information is needed, how to obtain that information, and what are the resources needed and priorities?
...
This category includes deciding how to analyze, organize, and draw conclusions from available information, reacting to unexpected information, and deciding upon a solution.
...
Reflection decisions occur throughout the process and include deciding whether assumptions are justified, whether additional knowledge or information is needed, how well the solution approach is working, and whether potential and then final solutions are adequate.
...
These are decisions about the broader implications of the work, and how to communicate results most effectively.
...
Although we focused on decisions in the problem-solving process, the experts volunteered general skills and knowledge they saw as important elements of problem-solving expertise in their fields.
