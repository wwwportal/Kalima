...
use kalima_core::{parse_verse_ref, EngineError, EngineResult, SearchHit, Segment, SegmentView, StorageBackend};
...
impl SqliteStorage {
    ...
    pub async fn upsert_annotation(
        &self,
        annotation: &kalima_core::Annotation,
    ) -> EngineResult<()> {
        sqlx::query(
            r#"
    ...
    pub async fn list_annotations(
    ...
    ) -> EngineResult<Vec<kalima_core::Annotation>> {
        ...
        for row in rows {
            out.push(kalima_core::Annotation {
